...
/**
 * Fachada pública para las vistas. Centraliza las modificaciones del modelo y
 * publica snapshots inmutables para mantener separadas la interfaz y la lógica.
 */
public class GameController {
    ...
    public void useObject(int handIndex, BoardSide targetSide, int boardPosition) {
        ...
        String effectType = normalizeEffectType(object);
    ...
    private String normalizeEffectType(Objeto object) {
        return object.getTipoEfecto() == null ? "" : object.getTipoEfecto().toUpperCase(Locale.ROOT);
    }
